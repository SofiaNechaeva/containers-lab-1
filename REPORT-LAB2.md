...
### 7. Выводы
    Последовательно разобралась с элементами kubernetes Pod --> ReplicaSet --> Deployment --> Service.На практике увидела, как kubernetes пересоздаёт пропавшие элементы и обеспечивает отказоустойчивость, возможности отладки. Преодалела непонимание  особенности раьоты временного хранилища (emptyDir)
